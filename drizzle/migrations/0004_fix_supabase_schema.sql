...
-- Drop all policies
    ...
    -- Explicitly drop "Users can view own data" policy to avoid dependency error
EXECUTE 'DROP POLICY IF EXISTS "Users can view own data" ON users CASCADE';
    ...
    FOR r IN 
        ...
        AND column_name NOT IN ('id', 'user_id', 'email', 'full_name', 'created_at', 'updated_at')
    LOOP
